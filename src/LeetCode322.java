...
public class LeetCode322 {
    static final int AMOUNT = (int) (Math.random() * 100 + 1);
    static final int COIN_LENGTH = (int) (Math.random() * 10 + 1);

    public static void main(String[] args) {
        LeetCode322 leetcode = new LeetCode322();

        int[] COINS = new int[COIN_LENGTH];
        System.out.println("COIN_LENGTH = " + COIN_LENGTH);
        ...
        int min = leetcode.coinChange(COINS, AMOUNT);
